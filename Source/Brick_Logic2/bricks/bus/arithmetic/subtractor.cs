datablock fxDTSBrickData (busSubtractorBrick2x2Data : Powerbrick1x1Data)
{
	category = "Bus Bricks";
	subCategory = "Arithmetic";
	uiName = "Bus Subtractor";
	iconName = "base/client/ui/brickIcons/2x2f";
	brickFile = "Add-Ons/Brick_Logic2/bricks/Gate2x2f.blb";
	alwaysShowWireFrame = false;
	IsLogicBrick = 1;
	IsGate = 1;
	GateName = "Bus Subtractor";
...
function busSubtractorBrick2x2Data::DoLog(%data, %gate, %statestack, %client)
{
