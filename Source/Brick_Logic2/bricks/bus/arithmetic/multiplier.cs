datablock fxDTSBrickData (busMultiplierBrick2x2Data : Powerbrick1x1Data)
{
	category = "Bus Bricks";
	subCategory = "Arithmetic";
	uiName = "Bus Multiplier";
	iconName = "base/client/ui/brickIcons/2x2f";
	brickFile = "Add-Ons/Brick_Logic2/bricks/Gate2x2f.blb";
	alwaysShowWireFrame = false;
	IsLogicBrick = 1;
	IsGate = 1;
	GateName = "Bus Multiplier";
	TipInfo = "Multiplies A by B";
	ISINSTANT = 0;
...
function busMultiplierBrick2x2Data::DoLog(%data, %gate, %statestack, %client)
{
