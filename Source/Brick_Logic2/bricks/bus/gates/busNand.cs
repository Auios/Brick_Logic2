datablock fxDTSBrickData (busNANDBrick2x2Data : Powerbrick1x1Data)//base
{
	category = "Bus Bricks";
	subCategory = "Basic Gates";
	uiName = "Bus NAND Gate";
	iconName = "base/client/ui/brickIcons/2x2f";
	brickFile = "Add-Ons/Brick_Logic2/bricks/Gate2x2f.blb";
	alwaysShowWireFrame = false;
	IsLogicBrick = 1;
	IsGate = 1;
	GateName = "Bus NAND Gate";
	TipInfo = "Bitwise NAND";
...
function busNANDBrick2x2Data::DoLog(%data, %gate, %statestack, %client)
{
