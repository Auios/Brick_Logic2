datablock fxDTSBrickData (Enabler8bitBrick4x16Data : Powerbrick1x1Data)
{
	...
	brickFile = "base/data/bricks/flats/2x10F.blb";
	...
	PEName[1] = "Out1";
	PEPos[1] = "0.75 0.25 0.0";
	PEScale[1] = "0.5 0.5 0.16666";
	PEStart[1] = 0;	

	PEName[2] = "Out2";
	PEPos[2] = "0.25 0.25 0.0";
	PEScale[2] = "0.5 0.5 0.16666";
	PEStart[2] = 0;	

	PEName[3] = "Out3";
	PEPos[3] = "-0.25 0.25 0.0";
	...
	PEName[5] = "Out5";
	PEPos[5] = "-1.25 0.25 0.0";
	PEScale[5] = "0.5 0.5 0.16666";
	PEStart[5] = 0;	

	PEName[6] = "Out6";
	PEPos[6] = "-1.75 0.25 0.0";
	PEScale[6] = "0.5 0.5 0.16666";
	PEStart[6] = 0;	

	PEName[7] = "Out7";
	PEPos[7] = "-2.25 0.25 0.0";
	...
	IEName[6] = "In6";
	IEPos[6] = "-1.75 -0.25 0.0";
	IEScale[6] = "0.5 0.5 0.16666";

	IEName[7] = "In7";
	IEPos[7] = "-2.25 -0.25 0.0";
	IEScale[7] = "0.5 0.5 0.16666";

	IEName[8] = "Enable";
	IEPos[8] = "2.25 -0.25 0.0";
